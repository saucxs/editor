...
# 示例文章：JS引擎到底是怎么执行？(一)
> js是一种非常灵活的语言，理解js引擎的执行过程对于我们学习js是非常有必要的。看了很多这方便文章，大多数是讲的是事件循环（event loop）或者变量提升的等，并没有全面分析其中的过程。所以觉得把这个js执行的详细过程整理一下，帮助更好的理解js，接下来我们一起来看看。
...
(function() {
  var input, output;
  var converter = new showdown.Converter();  // 中文注解中文注解中文注解中文注解

  function updateOutput() {
      output.innerHTML = converter.makeHtml(input.value);
  }
	// 中文注解中文注解中文注解中文注解中文注解
  document.addEventListener("DOMContentLoaded", function(event) {   // 中文注解中文注解中文注解中文注解中文注解
    input = document.getElementById('input');
    output = document.getElementById('output');
	// 中文注解中文注解中文注解中文注解 中文注解中文注解中文注解中文注解中文注解中文注解中文注解中文注解中文注解中文注解中文注解中文注解
    input.addEventListener('input', updateOutput, false); input.addEventListener('keydown', updateOutput, false); input.addEventListener('keydown', updateOutput, false);
...
欢迎关注我的公众号“松宝写代码”，精选文章第一时间推送。

<center>
    <img src="https://raw.githubusercontent.com/saucxs/full_stack_knowledge_list/master/image/songbao.png?raw=true" style="width: 100%;">
</center>
